...
import fr.curie.miclearning.prediction.translator.basetranslator.ImpObjectDetectionTranslator;
...
/**
 * A ImageJ translator for YoloV5 models.
 * Adapted from <a href="https://github.com/deepjavalibrary/djl/blob/9d720beeac2935da352369c6b2c45486ed3b1996/api/src/main/java/ai/djl/modality/cv/translator/YoloV5Translator.java">djl/YoloV5Translator</a>
 */
...
public class ImpYoloV5Translator extends ImpObjectDetectionTranslator {
     ...
     */
    protected ImpYoloV5Translator(Builder builder) {
        super(builder);
    ...
    /**
     * Creates a builder to build a {@link ImpYoloV5Translator}.
     *
    ...
    /**
     * Creates a builder to build a {@code ImpYoloV5Translator} with specified arguments.
     *
    ...
    /** An enum represents the Yolo output type. */
    ...
    /** The builder for {@link ImpYoloV5Translator}. */
    public static class Builder extends ImpObjectDetectionBuilder<Builder> {
         ...
         */
        public ImpYoloV5Translator build() {
            ...
            validate();
            return new ImpYoloV5Translator(this);
        }
    }
